...
from .modeling.mask_decoder_hq import MaskDecoderHQ_text
...
def build_sam_text_vit_h(checkpoint = None):
    return _build_text_sam(
        encoder_embed_dim = 1280,
        encoder_depth = 32,
        encoder_num_heads = 16,
        encoder_global_attn_indexes = [7, 15, 23, 31],
...
sam_model_registry = {
    ...
    'text_vit_h': build_sam_text_vit_h
}
...
def _build_text_sam(
    ...
    sam = Sam(
        ...
        mask_decoder=MaskDecoderHQ_text(
            num_multimask_outputs=3,
            transformer=TwoWayTransformer(
                depth=2,
                embedding_dim=prompt_embed_dim,
